  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: '0rem 1rem 11rem var(--card-shadow-color)',
      },
      dropShadow: {
        ...
        retro: '0 0 4rem var(--retro-shadow-color)',
      },
      borderRadius: {
        '4xl': '2.5rem',
      },
      backgroundImage: {
        retro:
          'linear-gradient(180deg, var(--secondary) 20.43%, #E0E5CE 25.48%, #E0E5CE 41.4%, #4300F5 46.3%, #263DB4 61.69%, var(--primary) 77.42%)',
        metallic:
