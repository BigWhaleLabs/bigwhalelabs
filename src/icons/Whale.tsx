...
const svgWrapper = (large?: boolean) =>
  classnames(
    ...
    width(
      large
        ? { 'sm:w-40': true, 'w-32': true }
        : { 'sm:w-16': true, 'w-12': true }
    )
  )
  ...
  return (
    <div className={svgWrapper(large)}>
      <svg viewBox="0 0 62 55" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <circle className={circleFill} cx="17.8986" cy="24.1426" r="1.57043" />
        <path
          className={mainStroke}
        ...
        />
        <path className={mainStroke} d="M40.8594 13.8537L40.8594 11.1652" />
        <line
          className={mainStroke}
          x1="40.4875"
          x2="40.4875"
        ...
        />
        <path className={mainStroke} d="M36.7168 28.2636L35.2071 29.7772" />
        <path className={mainStroke} d="M46.5003 29.776L44.9973 28.2736" />
        <circle
