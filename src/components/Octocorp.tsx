...
const textCard = classnames(space('space-y-2'), maxWidth('max-w-400'))
const textCardHeader = space('space-y-4')
const textCardBody = space('space-y-6')
    ...
    <div className={wrapper}>
      ...
      <div className={textCard}>
        <div className={textCardHeader}>
          <PrimaryAccentText color="text-secondary">
            OCTO-CORP
          </PrimaryAccentText>
        </div>
